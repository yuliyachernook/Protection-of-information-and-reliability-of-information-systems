...
namespace Lab4
{
    public partial class Form1 : Form
    {
        ...
        private char Encrypt(char letter, char rPos, char mPos, char lPos)
        {
            //L-M-R
        ...
        private void encrytpBtnClick(object sender, EventArgs e)
        {
            ...
            encryptedText.Text += Encrypt((sender as Button).Text.ToLower().ToCharArray()[0], rotRPos, rotMPos, rotLPos);
        }
